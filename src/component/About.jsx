...
const About = () => {
  // Create a reference to the clip section
  const clipRef = useRef(null);
  const maskClipRef = useRef(null);

  useEffect(() => {
    // Animation logic for GSAP
    ...
    // Animation effect on the mask clip path
  ...
  return (
    <div id="about" className="min-h-screen w-screen">
      ...
      <div className="h-dvh w-screen" id="clip" ref={clipRef}>
        <div className="mask-clip-path about-image" ref={maskClipRef}>
          <img
            src="img/about.webp"
            alt="Background"
